...
class TabCure:
    ...
    The TabCure class handles the whole generation flow. It is used to fine-tune a large language model for tabular data,
    ...
    def __init__(self, llm: str, trainer_config=None, peft_config=None):
        ...
        # in case of loading LLaMA models
        except Exception:
            self.tokenizer = LlamaTokenizer.from_pretrained(self.llm)
    ...
    def fit(
        ...
        """Fine-tune TabCure using tabular data.
        ...
        Returns:
            TabCureTrainer used for the fine-tuning process
        """
        ...
        great_ds = TabCureDataset.from_pandas(df)
    ...
    def lora_fit(
        ...
        """Fine-tune TabCure using tabular data with LoRA.
    ...
    def load_finetuned_model(self, path: str):
        ...
        Load the weights of a fine-tuned large language model into the TabCure pipeline
    ...
    def load_from_dir(cls, path: str):
        ...
        Load trained TabCure model from directory.

        Args:
            path: Directory where TabCure model is saved

        Returns:
            New instance of TabCure loaded from directory
        """
    ...
    def _get_start_sampler(
        self, start_col: tp.Optional[str], start_col_dist: tp.Optional[tp.Union[tp.Dict, tp.List]]
    ) -> TabCureStart:
        ...
        assert (
            start_col_dist is None or isinstance(start_col_dist, dict) or isinstance(start_col_dist, list)
