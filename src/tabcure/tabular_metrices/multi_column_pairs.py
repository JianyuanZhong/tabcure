    ...
    def _compute(self, real_data, synthetic_data, metadata=None, **kwargs):
        ...
        Returns:
            Union[float, tuple[float]]:
                Metric output.
        """
        real_data, synthetic_data, metadata = self._validate_inputs(real_data, synthetic_data, metadata)
    ...
    def compute_breakdown(cls, real_data, synthetic_data, metadata=None, **kwargs):
        ...
        Returns:
            dict:
                Metric output.
        """
        real_data, synthetic_data, metadata = cls._validate_inputs(real_data, synthetic_data, metadata)
        ...
        for columns in combinations(fields, r=2):
            ...
            breakdown[sorted_columns] = cls.column_pairs_metric.compute_breakdown(real, synthetic, **kwargs)
