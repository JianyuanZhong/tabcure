...
class MultiSingleColumnMetric(SingleTableMetric, metaclass=nested_attrs_meta("single_column_metric")):
            ...
            if column_name in fields:
                ...
                try:
                    score = self.single_column_metric.compute_breakdown(
                        real_column, synthetic_column, **(self.single_column_metric_kwargs or {}), **kwargs
                    )
