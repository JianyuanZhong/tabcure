...
class CategoricalPrivacyMetric(SingleTableMetric):
    ...
    def _validate_inputs(cls, real_data, synthetic_data, metadata, key_fields, sensitive_fields):
        real_data, synthetic_data, metadata = super()._validate_inputs(real_data, synthetic_data, metadata)
    ...
    @classmethod
    def compute(
        cls, real_data, synthetic_data, metadata=None, key_fields=None, sensitive_fields=None, model_kwargs=None
    ):
        """Compute this metric.
    ...
    def score(self, key_data, sensitive_data):
        ...
        Args:
            ...
            sensitive_data(tuple):
                The sensitive data.
        """
        raise NotImplementedError("Posterior probability based scoring not supported" "for this attacker!")
