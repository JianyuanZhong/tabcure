...
from sdmetrics.single_table.privacy.base import CategoricalPrivacyMetric, CategoricalType, PrivacyAttackerModel
...
class CategoricalSklearnAttacker(PrivacyAttackerModel):
    ...
    def __init__(self):
        ...
        self.key_processor = (
            ...
            if self.KEY_TYPE == CategoricalType.CLASS_NUM
            else OneHotEncoder()
        )
